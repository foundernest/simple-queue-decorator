...
var rabbitService = new service_1["default"]();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, rabbitService.connect()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function registerQueue(queueName, cb) {
    rabbitService.registerQueue(queueName, cb);
}
exports.registerQueue = registerQueue;
function OnQueue(queueName) {
    return function (target, _propertyKey, propertyDescriptor) {
        rabbitService.registerQueue(queueName, propertyDescriptor.value.bind(target));
    };
}
